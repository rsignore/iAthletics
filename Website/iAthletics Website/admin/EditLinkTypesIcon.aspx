<%@ Page Title="Edit Seasons Icon" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EditLinkTypesIcon.aspx.cs" Inherits="admin_EditLinkTypesIcon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>
        Editing Icon for
        Link Type
        <asp:Label ID="LinkTypeLabel" runat="server"></asp:Label>
    </h2>
    <p>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="CancelButton" runat="server" Text="Cancel" 
                        PostBackUrl="~/admin/LinkTypes.aspx" /></td>
            </tr>
        </table>
        </p>
</asp:Content>
