<%@ Page Title="Edit Sports Icon" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EditSportsIcon.aspx.cs" Inherits="admin_EditSportsIcon" %>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="CancelButton" runat="server" Text="Cancel" 
                        PostBackUrl="~/admin/Sports.aspx" /></td>
            </tr>
        </table>
        </p>
</asp:Content>
