...
/// <summary>
/// Summary description for GetUpcommingEvents1_0
/// </summary>
public class GetUpcommingEvents1_0: iAthleticsService1_0
{
    public List<Event> Events;

    protected virtual string GetQueryString()
    {
        return "EXECUTE GetUpcommingEvents @appId";
    }

	public GetUpcommingEvents1_0() : 
        base()
	{
        Init();
	}

    public GetUpcommingEvents1_0(HttpContext context) :
        base(context)
    {
        Init();
    }
    ...
    public bool ExecuteService(int appId, string deviceId)
    {
        ...
        string appNameQry = GetQueryString();
